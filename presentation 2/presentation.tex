...
\begin{center}
\IfFileExists{Chat with Nicholas.png}{\includegraphics[width=0.88\textwidth]{Chat with Nicholas.png}}{\IfFileExists{map.png}{\includegraphics[width=0.88\textwidth]{map.png}}{\textit{[Insert occupancy grid screenshot with robot trajectory]}}}
